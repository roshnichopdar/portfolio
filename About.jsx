...
const ABOUT_COPY = {
  ...
  paragraphs: [
    "I'm Roshni, a marketer shaped by two worlds: the fast-moving creator economy and the operational discipline of enterprise technology. I spent four years scaling a beauty creator from a bedroom studio to 446K+ followers and a $85K academy launch, then sharpened that instinct inside ServiceNow's product marketing org, where I learned how positioning, enablement, and messaging move at scale. Today, I bring that same rigor to AWS, supporting infrastructure business operations through data, process, and cross-functional coordination.",    
    ...
    "Today, I'm bringing that instinct to AWS, where I support infrastructure business operations through data analysis, process improvement, and cross-functional coordination. I'm still drawn to the intersection of brand storytelling, creator operations, performance analytics, and AI-powered workflows — I use AI not as a shortcut, but as a force multiplier, helping teams move faster while making more thoughtful decisions.",  ],
  sidebar: [
